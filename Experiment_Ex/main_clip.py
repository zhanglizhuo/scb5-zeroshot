...
SUBSET_DATA_DIR = {
    "teacher_behavior": REPO_ROOT / "datasets_scb" / "SCB5_TeacherBehavior" / "SCB5_Teacher_Behavior_Stand_BlackBoard_Sreen_20250406-2",
    "handrise_readwrite": REPO_ROOT / "datasets_scb" / "SCB5_HandriseReadWrite",
    "bow_turnhead": REPO_ROOT / "datasets_scb" / "SCB_BowTurnHead",
}
...
def run_single(model_key, subset, strategy, cape_set="A", device=None):
    ...
    data_dir = SUBSET_DATA_DIR.get(subset)
