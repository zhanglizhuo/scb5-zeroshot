...
mkdir -p scb5_zeroshot/Experiment_Ex/results/mllm_qwen_tb
mkdir -p scb5_zeroshot/Experiment_Ex/results/mllm_qwen_hr
mkdir -p scb5_zeroshot/Experiment_Ex/results/mllm_qwen_bt
...
python3 scb5_zeroshot/Experiment_Ex/main_mllm.py \
  --models qwen35_ollama \
  --qwen35_model qwen3.5:9b \
  --ollama_host http://127.0.0.1:11438 \
  --subsets teacher_behavior \
  --results_dir scb5_zeroshot/Experiment_Ex/results/mllm_qwen_tb > /tmp/qwen_tb.log 2>&1 &
...
python3 scb5_zeroshot/Experiment_Ex/main_mllm.py \
  ...
  --results_dir scb5_zeroshot/Experiment_Ex/results/mllm_qwen_hr > /tmp/qwen_hr.log 2>&1 &
...
python3 scb5_zeroshot/Experiment_Ex/main_mllm.py \
  ...
  --results_dir scb5_zeroshot/Experiment_Ex/results/mllm_qwen_bt > /tmp/qwen_bt.log 2>&1 &
