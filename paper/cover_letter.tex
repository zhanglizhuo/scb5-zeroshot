...
We would like to submit the enclosed manuscript, ``Adversarial Prompt Sensitivity in CLIP-Family Models for Zero-Shot Classroom Behavior Analysis,'' for consideration as an original research article in the Special Issue on \textit{Applications Based on Symmetry in Adversarial Machine Learning} in \textit{Symmetry}.
