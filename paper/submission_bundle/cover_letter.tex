...
The SCB datasets are publicly available at \url{https://huggingface.co/datasets/wintonYF/SCB-Dataset}. The reproducibility package (code, prompt templates, significance scripts) is available at \url{https://github.com/zhanglizhuo/scb-clip-benchmark}.
